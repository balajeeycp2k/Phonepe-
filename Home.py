...
agg_trans_df = pd.read_csv(
    r'D:/Python\Projects/Phonepe_Pulse/Miscellaneous/agg_trans.csv')
agg_user_df = pd.read_csv(
    r'D:/Python/Projects/Phonepe_Pulse/Miscellaneous/agg_user.csv')
map_trans_df = pd.read_csv(
    r'D:/Python/Projects/Phonepe_Pulse/Miscellaneous/map_trans.csv')
map_user_df = pd.read_csv(
    r'D:/Python/Projects/Phonepe_Pulse/Miscellaneous/map_user.csv')
top_trans_dist_df = pd.read_csv(
    r'D:/Python/Projects/Phonepe_Pulse/Miscellaneous/top_trans_dist.csv')
top_trans_pin_df = pd.read_csv(
    r'D:/Python/Projects/Phonepe_Pulse/Miscellaneous/top_trans_pin.csv')
top_user_dist_df = pd.read_csv(
    r'D:/Python/Projects/Phonepe_Pulse/Miscellaneous/top_user_dist.csv')
top_user_pin_df = pd.read_csv(
    r'D:/Python/Projects/Phonepe_Pulse/Miscellaneous/top_user_pin.csv')
...
st.set_page_config(
    ...
    page_icon='D:\Python\Projects\Phonepe_Pulse\Related Images and Videos\Logo.png'
)
...
st.image('D:\Python\Projects\Phonepe_Pulse\Related Images and Videos\1.png')
...
col3.metric(label='Total Transaction Count',
            value='2000 Cr +', delta='Forward Trend')

style_metric_cards(background_color='200329')

add_vertical_space(2)

st.image('D:\Python\Projects\Phonepe_Pulse\Related Images and Videos\Pulse.gif',
